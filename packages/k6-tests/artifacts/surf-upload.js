...
function upload_default({ userInfos }) {
  ...
  (0, import_lodash.times)(settings.assets.quantity, (i) => {
    userClient.resource.upload(userHome, [import_execution.default.scenario.iterationInTest, userCredential.login, i].join("-"), data);
  });
}
