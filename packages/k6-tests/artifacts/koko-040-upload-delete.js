...
// src/koko/040-upload-delete.ts
var upload_delete_exports = {};
__export(upload_delete_exports, {
  default: () => upload_delete_default,
  options: () => options,
  setup: () => setup,
  teardown: () => teardown
});
module.exports = __toCommonJS(upload_delete_exports);
...
function upload_delete_default({ userInfos }) {
  const defer = [];
