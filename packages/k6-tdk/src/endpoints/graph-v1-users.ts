...
export const POST__create_user:Endpoint<{userLogin: string, userPassword: string}, 'text'> = (r, { userLogin, userPassword }) => {
...
export const POST__add_app_role_to_user:Endpoint<{principalId: string, appRoleId: string, resourceId: string}, 'text'> = (r, { resourceId, principalId, appRoleId }) => {
